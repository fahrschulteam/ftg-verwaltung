    ...
    view.innerHTML = `
      <div class="mod-shell" id="personal-mod-shell">
        <aside class="mod-side"><nav>
          ...
          <button class="mod-side-btn" data-ps="aktiv" onclick="setPStatus('aktiv')"><span style="font-size:16px;width:20px;text-align:center">👥</span><span class="mod-lbl">Aktive (<span id="p-cnt-aktiv">0</span>)</span></button>
          <button class="mod-side-btn" data-ps="archiviert" onclick="setPStatus('archiviert')"><span style="font-size:16px;width:20px;text-align:center">🗂</span><span class="mod-lbl">Ausgeschieden (<span id="p-cnt-archiv">0</span>)</span></button>
          <div class="mod-side-divider"></div>
          <div class="mod-side-label">Bereich</div>
          <button class="mod-side-btn" data-pb="all" onclick="setPBereich('all')"><span style="font-size:16px;width:20px;text-align:center">◎</span><span class="mod-lbl">Alle</span></button>
          <button class="mod-side-btn" data-pb="fahrlehrer" onclick="setPBereich('fahrlehrer')"><span style="font-size:16px;width:20px;text-align:center">🎓</span><span class="mod-lbl">Fahrlehrer</span></button>
          <button class="mod-side-btn" data-pb="verwaltung" onclick="setPBereich('verwaltung')"><span style="font-size:16px;width:20px;text-align:center">💼</span><span class="mod-lbl">Verwaltung</span></button>
          <button class="mod-side-btn" data-pb="sonstige" onclick="setPBereich('sonstige')"><span style="font-size:16px;width:20px;text-align:center">👤</span><span class="mod-lbl">Sonstige</span></button>
        </nav></aside>
