...
<div class="mod-shell">
  <aside class="mod-side"><nav>
    ...
    <button class="mod-side-btn" onclick="if(confirm('Neuen KVA starten? Alle Eingaben werden gel\\u00f6scht.'))resetAll()"><span style="font-size:15px;width:20px;text-align:center">📄</span><span class="mod-lbl">Neu</span></button>
    <button class="mod-side-btn" onclick="openKvaDialog()"><span style="font-size:15px;width:20px;text-align:center">📂</span><span class="mod-lbl">Öffnen</span></button>
    <div class="mod-side-divider"></div>
    <div class="mod-side-label">Einstellungen</div>
    <button class="mod-side-btn" onclick="showView('einstellungen');setTimeout(function(){if(typeof setEinstTab==='function')setEinstTab('kva');},150)"><span style="font-size:15px;width:20px;text-align:center">⚙️</span><span class="mod-lbl">KVA-Einstellungen</span></button>
  </nav></aside>
  <div class="mod-main">
