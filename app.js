...
if (f && !f.getAttribute('src')) f.setAttribute('src', 'schulung.html?v=20260915a');
...
function showView(view) {
  ...
  if (view === 'schulung') {
    ...
    f.setAttribute('src', 'schulung.html?v=20260915a');
  ...
  if (view === 'teilnehmer') {
    ...
    if (f && !f.getAttribute('src')) f.setAttribute('src', 'teilnehmer.html?v=20260915a');
  }
  if (view === 'kalender') {
